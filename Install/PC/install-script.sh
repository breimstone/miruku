...
echo "╰─────────────────────────────╯"
install_packages "Starter Packages" bspwm sxhkd ranger kitty imagemagick sddm xorg firefox rofi dunst pavucontrol pulseaudio picom feh cava fuse fastfetch zathura zathura-pdf-poppler papirus-folders-catppuccin-git nwg-look zsh task bluez bluez-utils pulseaudio-bluetooth bluetui downgrade
